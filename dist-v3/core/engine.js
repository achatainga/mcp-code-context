...
export class CodeContextEngine {
    ...
    async loadLanguage(name) {
        ...
        switch (name) {
            case "typescript":
                language = await import("tree-sitter-typescript").then(m => m.typescript);
                break;
            case "python":
                language = await import("tree-sitter-python");
                break;
            case "php":
                language = await import("tree-sitter-php").then(m => m.php);
                break;
            default:
